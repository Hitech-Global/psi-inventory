...
function patchIndexSource(src){if(src.includes(INDEX_MARKER))return src;return once(src,'</body>',INDEX_MARKER+'\n</body>','index anchor');}
...
module.exports={SERVER_MARKER,INDEX_MARKER,patchServerSource,patchIndexSource,apply};
