...
assert.strictEqual(report.groups[0].group.itemCount, 2, 'normalized parent must carry its finalized child count');
...
assert.strictEqual(cnReport.groups[0].group.itemCount, 7);
assert.strictEqual(cnReport.groups[1].group.itemCount, 6);
assert.strictEqual(cnPreview.groups[0].itemCount, cnReport.groups[0].group.itemCount);
assert.strictEqual(cnPreview.groups[1].itemCount, cnReport.groups[1].group.itemCount);
